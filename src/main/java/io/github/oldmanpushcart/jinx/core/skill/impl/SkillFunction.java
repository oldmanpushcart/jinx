package io.github.oldmanpushcart.jinx.core.skill.impl;
...
class SkillFunction implements Function<SkillFunction.Spec, String> {
    ...
    private static String toName(Skill.Header header) {
        return "skill$%s".formatted(header.name());
    }
